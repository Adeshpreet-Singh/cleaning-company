...
export default function Home() {
 ...
 const pricing = [
 { name: 'Basic', price: '$99', period: 'per visit', features: ['Standard clean', 'Up to 2 rooms', 'Dusting & vacuuming', 'Bathroom & kitchen wipe-down', 'Eco-friendly products'], highlight: false },
 { name: 'Standard', price: '$179', period: 'per visit', features: ['Deep clean', 'Up to 4 rooms', 'Inside appliances', 'Baseboards & light fixtures', 'Floor mopping & scrubbing', '100% satisfaction guarantee'], highlight: true },
 { name: 'Premium', price: '$299', period: 'per visit', features: ['Full property clean', 'All rooms included', 'Carpet shampooing', 'Window washing (interior)', 'Move-out ready', 'Same-day available'], highlight: false },
 ];
 ...
 className="text-sm text-gray-600 hover:text-sky-700 transition-colors focus-visible:outline-2 focus-visible:outline-sky-500 focus-visible:outline-offset-2 rounded capitalize"
 >
 {item}
 </button>
 ))}
 ...
 className="bg-sky-700 text-white px-6 py-2.5 rounded-full text-sm font-bold hover:bg-sky-800 transition-colors focus-visible:outline-2 focus-visible:outline-sky-500 focus-visible:outline-offset-2"
 >
 Free Quote
 </a>
 </div>
 ...
 <a href="tel:+121****2532" className="block bg-sky-700 text-white text-center px-6 py-3 rounded-full font-bold hover:bg-sky-800 transition-colors text-lg min-h-[48px] leading-[48px]">Call: +1-800-555-0270</a>
 </div>
 )}
 </nav>
 </header>
...
<p className="text-sky-800 text-sm font-bold tracking-widest mb-4">CLIENT REVIEWS</p>
 ...
 {[...Array(5)].map((_, j) => (
 <svg key={j} className={`w-5 h-5 ${j < t.rating ? 'text-yellow-400' : 'text-gray-500'}`} fill="currentColor" viewBox="0 0 20 20">
 <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
 </svg>
 ))}
 </div>
 <p className="text-gray-700 mb-3 italic leading-relaxed">"{t.text}"</p>
 <div className="border-t border-gray-200 pt-4">
 <p className="text-gray-900 font-medium">{t.name}</p>
 <p className="text-gray-600 text-sm">{t.role} • {t.date}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <a href="tel:+1-800-555-0270" className="text-sky-600 hover:text-sky-800 hover:underline">+1-800-555-0270</a>
 </div>
 </div>
 <div className="flex items-start gap-3">
 <div className="w-10 h-10 bg-sky-700/20 rounded-lg flex items-center justify-center flex-shrink-0" aria-hidden="true"></div>
 ...
 <a href="https://wa.me/+1-800-555-0270?text=Hi%20ProClean%2C%20I%27d%20like%20a%20free%20quote" target="_blank" rel="noopener noreferrer" className="text-sky-600 hover:text-sky-800 hover:underline">Chat with us on WhatsApp</a>
 </div>
 </div>
 </div>
 </div>
 ...
 <input id="contact-name" name="name" type="text" required placeholder="Chris Clean" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 focus:outline-none transition-colors" />
 </div>
 <div>
 <label htmlFor="contact-email" className="block text-sm font-medium text-gray-700 mb-2">Email</label>
 <input id="contact-email" name="email" type="email" required placeholder="chris@example.com" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 focus:outline-none transition-colors" />
 </div>
 <div>
 <label htmlFor="contact-phone" className="block text-sm font-medium text-gray-700 mb-2">Phone</label>
 <input id="contact-phone" name="phone" type="tel" placeholder="+1-800-555-0270" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 focus:outline-none transition-colors" />
 </div>
 <div>
 <label htmlFor="contact-service-type" className="block text-sm font-medium text-gray-700 mb-2">Service Type</label>
 <select id="contact-service-type" name="service" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 focus:outline-none transition-colors">
 <option value="">Select service</option>
 <option value="residential">Residential</option>
 <option value="commercial">Commercial</option>
 <option value="move-out">Move-Out / Move-In</option>
 ...
 <a href="tel:+1-800-555-0270" className="hover:text-white transition-colors">+1-800-555-0270</a><br />
 ...
 <li><span className="text-sky-300 text-sm">Move-Out / Move-In</span></li>
 <li><span className="text-sky-300 text-sm">Deep Cleaning</span></li>
 </ul>
 </div>
 <div>
 ...
 <a href="https://wa.me/+1-800-555-0270" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-sky-700 rounded-lg flex items-center justify-center text-white hover:bg-sky-600 transition-colors" aria-label="WhatsApp">
 ...
 <p className="text-sky-300 text-sm">© 2026 ProClean Company. All rights reserved.</p>
